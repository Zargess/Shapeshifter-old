...
:: signtool.exe sign /d "Shapeshifter installation" /p "Pindleskin1" /f "%PROJECTDIR%\Flamefusion.pfx" "%PROJECTDIR%\bin\debug\Shapeshifter.exe"
:: signtool.exe verify /pa "%PROJECTDIR%\bin\debug\Shapeshifter.exe"